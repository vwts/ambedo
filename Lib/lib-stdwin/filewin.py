# módulo 'filewin'
#
# janelas do arquivo, uma sub-classe do textwin (que é sub-classe do gwin)
...
def open_readonly(fn): # abre uma janela de aqruivo
    w = textwin.open_readonly(fn, readfile(fn))
    w.fn = fn
    
    return w

def open(fn): # abre uma janela de aqruivo
