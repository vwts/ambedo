...
# inicializar propriedades de áudio
audio.setrate(3)
audio.setoutgain(100) # para o speaker
...
def samp(n):
    ...
    try:
        ...
        x = raw_input('clique enter para sample ' + `n` + ' segundos: ')
...
def sinus(freq): # retornar uma sine wave de 1 segundo
